...
export default defineConfig({
  testDir: "tests/e2e",
  testMatch: ["browser-units.spec.ts", "gpu.spec.ts", "runtime-gpu.spec.ts", "runtime-cube.spec.ts", "runtime-cube-correctness.spec.ts", "runtime-animation.spec.ts", "playable-tetris.spec.ts", "presentation.spec.ts", "frame-oracle.spec.ts"],
